var util = {
	...
	/**
	 * layer寮瑰嚭妗� icon:0(榛樿)鎻愮ず淇℃伅锛�1鎴愬姛锛�2澶辫触
	 */
	...
	/**
	 * 缃戠粶璇锋眰 options
	 * {btn:褰撳墠鎿嶄綔鎸夐挳,url:璇锋眰鍦板潃,param:璇锋眰鍙傛暟,success:鎴愬姛鍥炶皟鍑芥暟,method:璇锋眰鏂规硶(post,get),type:鏈嶅姟鍣ㄥ搷搴旂殑鏁版嵁绫诲瀷,enter:鏄惁鏄洖杞︽墽琛寎
	 */
